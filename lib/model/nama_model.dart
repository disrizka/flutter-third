...
class NameModel {
  ...
  NameModel copyWith({String? nameSchool, String? address, String? phone}) {
    return NameModel(
  ...
  @override
  String toString() =>
      'NameModel(nameSchool: $nameSchool, address: $address, phone: $phone)';

  @override
  bool operator ==(covariant NameModel other) {
    if (identical(this, other)) return true;

    return other.nameSchool == nameSchool &&
